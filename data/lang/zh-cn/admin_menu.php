...
return array (
  'ADMIN_#_#' => '财务管理',
  'ADMIN_#_DEFAULT' => '货流',
  'ADMIN_ADDRESS_INDEX' => '收货地址',
  'ADMIN_CASHIER_INDEX' => '收银台',
  'ADMIN_CLASSIFICATION_INDEX' => '分类管理',
  'ADMIN_DEFAULT_INDEX' => '库存',
  'ADMIN_FOODMENU_INDEX' => '菜品管理',
  'ADMIN_HOOK_INDEX' => '钩子管理',
  'ADMIN_HOOK_PLUGINLISTORDER' => '钩子插件排序',
  'ADMIN_HOOK_PLUGINS' => '钩子插件管理',
  'ADMIN_HOOK_SYNC' => '同步钩子',
  'ADMIN_INVENTORY_INDEX' => '盘点',
  'ADMIN_KITCHEN_INDEX' => '后厨',
  ...
  'ADMIN_ORDER_DEFAULT' => ' 订单信息',
  'ADMIN_ORDER_INDEX' => '订单列表',
  'ADMIN_ORDER_ORDERADDLIST' => '消费下单',
  'ADMIN_ORDER_PRINTINDEX' => '销售排行榜',
  'ADMIN_ORDER_RESERVEORDER' => '预约信息',
  ...
  'ADMIN_SELLER_DEFAULT' => '门店管理',
  'ADMIN_SELLER_INDEX' => '门店信息',
  'ADMIN_SELLER_SELLERTABLE' => '餐桌管理',
  'ADMIN_SELLER_WITHDRAWALS' => '提现',
  ...
  'ADMIN_TRAFFIC_APPLY' => '申请列表',
  'ADMIN_TRAFFIC_INDEX' => '商品管理',
  'ADMIN_TRAFFIC_PURCHASE' => '采购',
  'ADMIN_TRAFFICCATEGORY_INDEX' => '商品分类',
  'ADMIN_TRAFFICCATEGORY_PURCHASE_INDEX' => '采购分类',
  'ADMIN_TRAFFICREPORT_INDEX' => '报表统计',
  'ADMIN_TRAFFICREPORT_LOSSINDEX' => '商品报损',
  ...
  'USER_ADMININDEX_DEFAULT1' => '会员',
  'USER_ADMININDEX_INDEX' => '本站用户',
  'USER_ADMINOAUTH_DELETE' => '删除第三方用户绑定',
  'USER_ADMINOAUTH_INDEX' => '会员管理',
  'USER_ADMINOAUTH_LEVELINDEX' => '会员等级',
  'USER_ADMINOAUTH_RECHARGE' => '充值记录',
