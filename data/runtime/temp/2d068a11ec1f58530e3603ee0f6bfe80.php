<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"themes/admin_simpleboot3/admin\traffic_report\statistics.html";i:1529378110;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('trafficReport/Statistics'); ?>">库存统计</a></li>
    </ul>
    <form class="well form-inline margin-top-20 js-ajax-form" method="post" action="<?php echo url('admin/trafficReport/Statistics'); ?>">
        <?php 
        ...
        <div class="form-inline">
            ...
            <span style="float:right">
                <a class="btn btn-info" href="<?php echo url('trafficReport/Statistics',array('time'=>'month')); ?>">本月</a>
                <a class="btn btn-info" href="<?php echo url('trafficReport/Statistics',array('time'=>'last month')); ?>">上个月</a>
            </span>
        </div>
    </form>
