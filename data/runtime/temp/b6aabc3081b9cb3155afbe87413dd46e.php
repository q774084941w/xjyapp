<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"themes/admin_simpleboot3/admin\traffic\trafficadd.html";i:1529050816;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
...
<div class="wrap js-check-wrap">
	...
	<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('traffic/addPost'); ?>" >
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-10">
				<input type="text" class="form-control" name="add[alert]" placeholder="报警库存">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				...
				<a class="btn btn-primary" href="<?php echo url('admin/traffic/export',array('type'=>0)); ?>" style="display: none;float: right" name="excels">模板下载</a>
			</div>
		</div>
	</form>
...
<script>
    ...
    $("#imgUpload")
        .fileinput({
            language: 'zh',
            uploadUrl: "<?php echo url('admin/traffic/do_upload',array('type'=>0)); ?>",
            autoReplace: true,
            maxFileCount: 1,
        ...
        .on("fileuploaded", function (e, data) {
            ...
            if (res.state > 0) {
                alert('上传成功');
                window.location.href="<?php echo url('traffic/index'); ?>";
            }
            else {
                alert('上传失败')
            }
