<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"themes/wechat_ordering/user\index\evaluation.html";i:1524828496;s:39:"themes/wechat_ordering/public\head.html";i:1524645681;s:38:"themes/wechat_ordering/public\nav.html";i:1524642742;s:41:"themes/wechat_ordering/public\footer.html";i:1528133890;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
              ...
              <view class="fr list-pric-text">
                  <view class="address-tel-text">
                    ...
                    <view class="fr operating">
                      <?php if($vo['pay'] == 1): ?>
                        <a hover-class="mine-navigator-hover" class="Dishes-operating" href="<?php echo cmf_url('user/index/place_order',['foodid'=>$vo['id']]); ?>">立即支付</a>
                      <?php elseif($vo['pay'] == 2): ?>
                        <a hover-class="mine-navigator-hover" class="Dishes-operating" href="<?php echo cmf_url('user/index/FoodList'); ?>">再来一单</a>
                      <?php elseif($vo['pay'] == 5): ?>
                        <a hover-class="mine-navigator-hover" class="Dishes-operating" href="<?php echo cmf_url('user/index/order_evaluate',['order_id'=>$vo['order_id']]); ?>">评价</a>
                      <?php endif; ?>
