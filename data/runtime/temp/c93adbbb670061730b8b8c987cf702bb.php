<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"themes/wechat_ordering/user\index\order_detailed.html";i:1524634469;s:39:"themes/wechat_ordering/public\head.html";i:1528451063;s:41:"themes/wechat_ordering/public\footer.html";i:1528860216;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <title>订单详细</title>
          ...
          <view class="Dishes-list">
            <view class="group">
              <view class="evaluation-Starrating">
                <?php if(!empty($order)): $__FOR_START_25300__=0;$__FOR_END_25300__=$order['delivery_evaluate'];for($i=$__FOR_START_25300__;$i < $__FOR_END_25300__;$i+=1){ ?>
                    ...
                    <?php } if($order['delivery_evaluate'] != 5): $__FOR_START_29163__=0;$__FOR_END_29163__=(5-$order['delivery_evaluate']);for($i=$__FOR_START_29163__;$i < $__FOR_END_29163__;$i+=1){ ?>
          ...
          <view class="Dishes-list" style='border:none;'>
            <view class="group">
              <view class="evaluation-description">
                <textarea class="weui-textarea" placeholder="亲，对菜品口味如何，对包装服务等还满意吗？" name="user_evaluate" rows="3" disabled="true" /><?php echo empty($order['user_evaluate'])?'':$order['user_evaluate']; ?></textarea>
                <!-- <text class='fr'>至少输入8个子</text> -->
                 <text class='fr'>
                   <?php echo empty($order['user_evaluate']) ? '您还没有评价' : mb_strlen($order['user_evaluate']); ?>
                 </text>
