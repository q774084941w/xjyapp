<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin\reserve\index.html";i:1530165933;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		...
		<?php 
		 ...
		 ?>
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('admin/reserve/index'); ?>">
	        ...
	        <a class="btn btn-danger" href="<?php echo url('admin/reserve/index'); ?>">清空</a>
	        <span style="float:right">
	        	<a class="btn btn-info" href="<?php echo url('admin/reserve/index',array('order_complete'=>'1')); ?>">最新预约</a>
	        	<a class="btn btn-info" href="<?php echo url('admin/reserve/index',array('order_complete'=>'2')); ?>">确认预约</a>
	        </span>
	    </form>
