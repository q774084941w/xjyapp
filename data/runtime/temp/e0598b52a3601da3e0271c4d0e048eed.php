<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin_simpleboot3/admin\menu\add.html";i:1511766888;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo url('menu/add'); ?>"><?php echo lang('ADMIN_MENU_ADD'); ?></a></li>
			<li><a href="<?php echo url('menu/lists'); ?>"><?php echo lang('ADMIN_MENU_LISTS'); ?></a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('menu/addPost'); ?>">
