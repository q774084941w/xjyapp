<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/admin\classification\edit.html";i:1524295170;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo url('Classification/index'); ?>">菜系添加</a></li>
        	<li><a href="<?php echo url('Classification/add'); ?>">新菜系添加</a></li>
        	<li  class="active"><a href="<?php echo url('Classification/Edit'); ?>">编辑菜系</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Classification/editPost'); ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					...
					<p class="help-block">
						<a href="<?php echo url('Classification/icon'); ?>" target="_blank">
							选择图标
						</a>
						不带前缀.icon-，如.icon-huoguo => huoguo
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					...
					<a class="btn btn-default" href="<?php echo url('Classification/index'); ?>">返回</a>
				</div>
			</div>
		</form>
	</div>
