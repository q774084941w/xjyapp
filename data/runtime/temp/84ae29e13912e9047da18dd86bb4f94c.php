<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin\user\userinfo.html";i:1511766888;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
	...
	<div class="wrap">
		...
		<form class="form-horizontal js-ajax-form margin-top-20" role="form" method="post" action="<?php echo url('User/userinfoPost'); ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-user_url" name="user_url" value="<?php echo $user_url; ?>" placeholder="http://www.ccapp.com.cn">
				</div>
			</div>
			<div class="form-group">
