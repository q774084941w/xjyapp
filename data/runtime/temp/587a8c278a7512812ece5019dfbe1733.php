<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin\rbac\index.html";i:1528358146;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
					...
					<tr>
						...
						<td>
							...
							<?php else: if($id!=$vo['id']): ?>
								...
								<a href="<?php echo url('Rbac/roleedit',array('id'=>$vo['id'])); ?>">
									<?php echo lang('EDIT'); ?>
								</a>
								<!--<?php if($id!=$vo['id']): ?>
								<a class="js-ajax-delete" href="<?php echo url('Rbac/roledelete',array('id'=>$vo['id'])); ?>">
