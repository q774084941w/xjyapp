<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"themes/wechat_ordering/user\index\reserve.html";i:1528448069;s:39:"themes/wechat_ordering/public\head.html";i:1528451063;s:38:"themes/wechat_ordering/public\nav.html";i:1524642742;s:41:"themes/wechat_ordering/public\footer.html";i:1528860216;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <title>我的预订</title>
  ...
  <body class="grade-a">
    ...
    <view class="group Top-position">
      <view>
        ...
        <a class="Top-position-all fr" href="<?php echo cmf_url('user/index/reserve'); ?>" hover-class="mine-navigator-hover" open-type="redirect">全部预订 ＞</a>
    ...
    <view class=" weui-tabbar Order-Status-Options">
        <a href="<?php echo cmf_url('user/index/sellerreserve'); ?>" hover-class="mine-navigator-hover" class='weui-tabbar__item <?php if(\think\Request::instance()->param('order_pay') == 2): ?> mine-navigator-hover <?php endif; ?>'>
          <icon class="iconfont icon-yuding" type="" size=""> </icon> 
          <!-- icon-paided -->
          我要预订
        </a>
        <a href="<?php echo cmf_url('user/index/reserve',['status'=>1]); ?>" hover-class="mine-navigator-hover" class='weui-tabbar__item <?php if(\think\Request::instance()->param('status') == 1): ?> mine-navigator-hover <?php endif; ?>'>
          <icon class="iconfont icon-book" type="" size=""> </icon>
          当前预订
        </a>
        <a href="<?php echo cmf_url('user/index/reserve',['status'=>2]); ?>" hover-class="mine-navigator-hover" class='weui-tabbar__item <?php if(\think\Request::instance()->param('status') == 2): ?> mine-navigator-hover <?php endif; ?>'>
    ...
    <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): ?>
      ...
      <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
        <div class="weui-flex weui-td">
          ...
          <div class="weui-flex__item">
            <div class="placeholder">
              <?php echo $vo['menu_name']; ?>厅-<?php echo $vo['table_name']; ?>
            </div>
          </div>
          <div class="weui-flex__item">
            <div class="placeholder">
              <?php echo date('Y-m-d H:i',$vo['reserve_time']); ?>
            </div>
          </div>
          <div class="weui-flex__item">
            <div class="placeholder">
              <a href="<?php echo cmf_url('user/index/reserve_detailed',['id'=>$vo['id']]); ?>">查看</a> 
              <?php if(\think\Request::instance()->param('status') == 2): if($vo['seller_confirm'] == 3):  $stase_name = '商家拒绝';  elseif($vo['seller_confirm'] == 2): if($vo['complete'] == 2):  $stase_name = '已完成';  else:  $stase_name = '商家已确认';  endif; else: if($vo['complete'] == 1):  $stase_name = '等待商家确认';  elseif($vo['complete'] == 3):  $stase_name = '商家违约';  elseif($vo['complete'] == 4):  $stase_name = '已取消';  endif; endif; ?>

                |  <font color="#999"> <?php echo $stase_name; ?> </font>
                
              <?php else: if(($vo['seller_confirm'] == 1) AND  ($vo['complete'] == 1)): ?>
                  |  <a href="<?php echo cmf_url('user/index/reserve',['id'=>$vo['id'],'complete'=>4]); ?>" class="js-ajax-dialog-btn" data-msg="确定取消该预订？">取消</a> 
                <?php endif; endif; ?>   
            </div>
          </div> 
        </div>
