<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_simpleboot3/user\admin_index\index.html";i:1511775125;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
             ...
             if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <a href="<?php echo url('admin/seller/password',array('id'=>$vo['id'])); ?>" >修改密码</a>
                    </td>
                </tr>
