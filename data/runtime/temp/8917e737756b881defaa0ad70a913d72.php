<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"themes/wechat_ordering/user\index\payment.html";i:1524986542;s:39:"themes/wechat_ordering/public\head.html";i:1528451063;s:41:"themes/wechat_ordering/public\footer.html";i:1528860216;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <title>订单在线支付</title>
...
<?php 
 ...
 ?>
  ...
  <form action="<?php echo url('user/index/not_payment'); ?>" method="post" class='js-ajax-form'>
        ...
        <view class="Dishes-list">
          <view class="group">
            <view class="Service-fee">
              ...
              <text class='fr' style='color:#D13BF5;'> -￥<?php echo empty($order['discount_price']) ? 0 : ($order['order_price']-$order['discount_price']); ?> </text>
              <view class="clear"></view>
            </view>
          </view>
        </view>
    ...
    <view class="footer-shopping-cart-fixed footer-shopping-totals-pay" style='bottom:0;'>
      <view class="footer-shopping-cart"> 
        <view class="total fl">
            <text>合计：</text>
            <text class='totals-prc'>￥<?php echo $order['order_price']; ?> </text>
        </view>
