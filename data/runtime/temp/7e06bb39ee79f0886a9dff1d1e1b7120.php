<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"themes/admin_simpleboot3/admin\traffic_report\shipments.html";i:1529411047;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('admin/trafficReport/index'); ?>">进货统计</a></li>
        <li  class="active"><a href="">出库统计</a></li>
        <li><a href="<?php echo url('trafficReport/alert'); ?>">库存报警</a></li>
        <li><a href="<?php echo url('trafficReport/Statistics'); ?>">库存统计</a></li>
    </ul>
    <form class="well form-inline margin-top-20 js-ajax-form" method="post" action="<?php echo url('admin/trafficReport/Shipments'); ?>">
        <?php 
        ...
        <div class="form-inline">
            ...
            <span style="float:right">
                <a class="btn btn-info" href="<?php echo url('trafficReport/Shipments',array('time'=>'today')); ?>">今日</a>
                <a class="btn btn-info" href="<?php echo url('trafficReport/Shipments',array('time'=>'yesterday')); ?>">昨天</a>
                <a class="btn btn-info" href="<?php echo url('trafficReport/Shipments',array('time'=>'week')); ?>">本周</a>
                <a class="btn btn-info" href="<?php echo url('trafficReport/Shipments',array('time'=>'month')); ?>">本月</a>
                <a class="btn btn-info" href="<?php echo url('trafficReport/Shipments',array('time'=>'last month')); ?>">上个月</a>
            </span>
        </div>
    </form>
        ...
        <table class="table table-hover table-bordered">
            ...
            <?php if(!empty($data)): if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <tr>
                        ...
                        <td class="before">
                            <a href="<?php echo url('trafficReport/detailed',array('tra_id'=>$vo['tra_id'],'type'=>2,'time'=>$whereTime)); ?>">
                                <?php echo $vo['all_num']; ?>
                            </a>
                        </td>
            ...
            <tfoot>
                <tr>
                    <td colspan="9" align="center"> 
                        <a href="<?php echo url('trafficReport/print2',$where); ?>" class="btn btn-danger">打印</a>
                    </td>
                </tr>
            </tfoot>
            <tfoot>
