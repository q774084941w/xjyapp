<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin_simpleboot3/admin\user\add.html";i:1528876560;s:43:"themes/admin_simpleboot3/public\header.html";i:1511766886;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo url('user/add'); ?>">用户添加</a></li>
		</ul>
		<form method="post" class="form-horizontal  margin-top-20 js-ajax-form" action="<?php echo url('user/addpost'); ?>">
			...
			<div class="form-group">
				<label for="input-harge" class="col-sm-2 control-label">充值密码</label>
				<div class="col-md-6 col-sm-10">
					<input type="password" class="form-control" id="input-harge" name="harge" placeholder="非必填项">
				</div>
			</div>
			<div class="form-group">
