<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"themes/wechat_ordering/user\index\my.html";i:1527825808;s:39:"themes/wechat_ordering/public\head.html";i:1524645681;s:38:"themes/wechat_ordering/public\nav.html";i:1524642742;s:41:"themes/wechat_ordering/public\footer.html";i:1528133890;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <title>我的-个人中心</title>
...
<?php 
 ...
 ?>
  ...
  <body class="grade-a">
    ...
    <view class="group Me-Top-position">
      <view>
        <?php if(empty($user['avatar']) || (($user['avatar'] instanceof \think\Collection || $user['avatar'] instanceof \think\Paginator ) && $user['avatar']->isEmpty())): ?>
          <image src="__TMPL__/public/assets/images/Default-avatar.png" class="avatar" />
        <?php else: ?>
          <image src="<?php echo cmf_get_image_url($user['avatar']); ?>" class="avatar" />
        <?php endif; ?>
        <text class='Wechat-nickname'><?php echo $user['user_nickname']; ?></text>
        <view class="clear"></view>
      </view>  
    </view>

    <!-- 纵向菜单 -->
    <div class=" weui-tabbar Order-Status-Options Me-Order-Status-Options weui-tabbar-me">
        <!-- <a href="#" hover-class="mine-navigator-hover" class='group padtopjianju weui-tabbar__item weui-tabbar__item_'>
          <view class='fl'>
            <icon class="iconfont icon-shoucang" type="" /></icon>
            <font>我的收藏</font>
          </view>
          <view class='fr jintou'> > </view>
          <view class='clear'></view>
        </a> -->
        <a href="<?php echo cmf_url('user/index/evaluation',['order_pay'=>6]); ?>" hover-class="mine-navigator-hover" class='group padtopjianju weui-tabbar__item weui-tabbar__item_'>
          <view class='fl'>
             <icon class="iconfont icon-pingjia" type="" /></icon>
             <font> 我的评价</font>
          </view>
          <view class='fr jintou'> > </view>
          <view class='clear'></view>
        </a>
        <a href="#" hover-class="mine-navigator-hover" class='group padtopjianju weui-tabbar__item weui-tabbar__item_' onclick="Prompt()">
          <view class='fl'>
             <icon class="iconfont icon-coupon" type="" /></icon>
             <font>我的优惠劵</font>
          </view>
          <view class='fr jintou'> > </view>
          <view class='clear'></view>
        </a>
        <a href="<?php echo url('user/index/login_out'); ?>" hover-class="mine-navigator-hover" class='group padtopjianju weui-tabbar__item weui-tabbar__item_ login_out' style="display: none;">
          <view class='fl'>
             <icon class="iconfont icon-qiehuanzuhu" type="" /></icon>
             <font>退出</font>
          </view>
          <view class='fr jintou'> > </view>
          <view class='clear'></view>
       ...
       <!--  <a href="" hover-class="mine-navigator-hover" class='group padtopjianju weui-tabbar__item weui-tabbar__item_'>
          <view class='fl'>
             <icon class="iconfont icon-wodedizhi" type="" /></icon>
             <font> 我的地址</font>
          </view>
          <view class='fr jintou'> > </view>
          <view class='clear'></view>
...
<script type="text/javascript">
  //weixin  js-sdk
   SetShareConfig('<?php echo $signPackage['appId']; ?>',<?php echo $signPackage['timestamp']; ?>,'<?php echo $signPackage['nonceStr']; ?>','<?php echo $signPackage['signature']; ?>');
    function Prompt() {
        layer.msg('该功能还在研发中！');
    }
